 ...
 */
package GestionEquipement.CategoryEquipement;
...
public class CategoryequipementController implements Initializable {
    ...
    private void GoToAffichage(ActionEvent event) {
        ...
        try {
            ...
            Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/GestionEquipement/AffichageEquipement/AfficherProduits.fxml")));
